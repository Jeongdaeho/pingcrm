...
import SidebarMenuLink from '@/Menus/components/SidebarMenuLink.vue'
import SidebarMenuIcon from '@/Menus/components/SidebarMenuIcon.vue'
import SidebarMenuBadge from '@/Menus/components/SidebarMenuBadge.vue'
