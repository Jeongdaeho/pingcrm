<template>
  ...
  >
    ...
    <div
      ...
      :style="isCollapsed && {'margin-right': '-9px'}"
    >
      <div
        class="vsm--list"
...
<script>
import SidebarMenuItem from '@/Menus/components/SidebarMenuItem.vue'
  ...
  methods: {
    ...
    initParentOffsets () {
      ...
      if (this.relative) {
        ...
        this.parentOffsetLeft = sidebarLeft - (parentLeft + parent.clientLeft)
      } else {
        this.parentOffsetTop = sidebarTop
        this.parentOffsetLeft = sidebarLeft
      }
    },
